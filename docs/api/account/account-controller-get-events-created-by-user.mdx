...
Returns the events the authenticated user authored, regardless of whether they are upcoming or past. It powers an organizer-facing listing; the current mobile build does not wire it to a screen.
